            ...
            <header className="flex items-center justify-between w-full h-[100px] border-2 border-b-gray-300">
                ...
                <div className="flex items-center justify-center" >
                    ...
                    <div className="w-[80px] h-[80px] rounded-full bg-[#D9D9D9] mr-[15px] cursor-pointer hover:scale-110" onClick={toggleMenu}>
                        <img src={usuario.icon !== ""? "http://localhost:5000/profile/icons/"+usuario.icon: ""} className="object-contain w-full h-full rounded-full"></img>
                        <ul className={`menu__items z-10 w-[200px] flex flex-col items-center justify-center bg-white rounded-[5px] absolute right-0 border-2 border-gray-200 cursor-pointer ${isOpen? '' : 'hidden'}`}>
                            ...
                            <li className="menu__item hover:scale-110" onClick={()=>{push("/publications")}}>Ver publicaciones</li>
